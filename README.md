...
| [Part 2: Optimizing Dockerfiles with Multi-Stage Builds](https://spmahapatra.github.io/part-2-optimizing-dockerfiles-with-multi-stage-builds) | `docker` `devops` `tutorial` `performance` |
